...
import { ReactiveRegisterUserComponent } from './components/reactive-register-user/reactive-register-user.component';
...
const routes: Routes = [
  ...
  {path: 'register-reactive', component: ReactiveRegisterUserComponent},
